...
@section('content')
  <div class="container mx-auto px-4 py-8 min-h-screen">
      <div class="bg-blue-500 p-3 mb-8 text-lg rounded-lg shadow" role="alert">
        <h4 class="font-bold text-white text-lg">Selamat Datang di Data Sbanda..!! <br>
        ...
        <div class="bg-white rounded-2xl p-6 lg:p-8 shadow-lg mb-8">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 pb-4 border-b-2 border-gray-100">
                ...
                <button class="bg-gradient-to-r from-blue-500 to-cyan-400 text-white px-6 py-2 rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-500 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg">
                    <span>Filter</span>
                </button>
            </div>
